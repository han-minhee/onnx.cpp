...
namespace HIP_OP
{
                                                   ...
                                                   const std::unordered_map<std::string, Node::AttributeValue> &attributes, Device *device)
    {
        ...
        case TensorDataType::FLOAT64:
            hipKernelLaunchCheck(hipLaunchKernelGGL(mul_kernel<double>, gridSize, blockSize, 0, 0,
        ...
        case TensorDataType::INT64:
            hipKernelLaunchCheck(hipLaunchKernelGGL(mul_kernel<int64_t>, gridSize, blockSize, 0, 0,
        ...
        case TensorDataType::INT32:
            hipKernelLaunchCheck(hipLaunchKernelGGL(mul_kernel<int32_t>, gridSize, blockSize, 0, 0,
        ...
        case TensorDataType::INT8:
            hipKernelLaunchCheck(hipLaunchKernelGGL(mul_kernel<int8_t>, gridSize, blockSize, 0, 0,
        ...
        case TensorDataType::UINT8:
            hipKernelLaunchCheck(hipLaunchKernelGGL(mul_kernel<uint8_t>, gridSize, blockSize, 0, 0,
        ...
        case TensorDataType::FLOAT16:
            hipKernelLaunchCheck(hipLaunchKernelGGL(mul_kernel<half_t>, gridSize, blockSize, 0, 0,
