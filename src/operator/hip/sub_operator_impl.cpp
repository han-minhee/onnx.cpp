...
namespace HIP_OP
{
    ...
    template <typename T>
    __global__ void sub_kernel(const T *__restrict__ A_data, const size_t *__restrict__ A_dims, const size_t *__restrict__ A_strides,
                                                   ...
                                                   const std::unordered_map<std::string, Node::AttributeValue> &attributes, Device *device)
    {
        ...
        case TensorDataType::FLOAT32:
            hipKernelLaunchCheck(hipLaunchKernelGGL(sub_kernel<float>, gridSize, blockSize, 0, 0,
        ...
        case TensorDataType::FLOAT64:
            hipKernelLaunchCheck(hipLaunchKernelGGL(sub_kernel<double>, gridSize, blockSize, 0, 0,
        ...
        case TensorDataType::INT64:
            hipKernelLaunchCheck(hipLaunchKernelGGL(sub_kernel<int64_t>, gridSize, blockSize, 0, 0,
