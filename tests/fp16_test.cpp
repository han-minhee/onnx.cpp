...
// ----------------------- AddOperator Tests -----------------------
TEST(FP16TestCPU, AddOperatorBasic)
{
...
// ----------------------- AddOperator Tests -----------------------
TEST(FP16TestHIP, AddOperatorBasic)
{
...
TEST(FP16TestHIP, AddOperatorBroadcastVector)
{
...
// ----------------------- SubOperator Tests -----------------------
TEST(FP16TestHIP, SubOperatorBasic)
{
...
TEST(FP16TestHIP, SubOperatorShapeMismatchError)
{
    HipDevice hipDevice = HipDevice(0);
    Tensor t1(TensorDataType::FLOAT16, {2, 2}, std::vector<half_t>{1.0f, 2.0f, 3.0f, 4.0f}, &hipDevice);
...
TEST(FP16TestHIP, SubOperatorBroadcastScalar)
{
...
TEST(FP16TestHIP, SubOperatorBroadcastVector0)
{
...
TEST(FP16TestHIP, SubOperatorBroadcastVector1)
{
    // Broadcasting vector subtraction
    HipDevice hipDevice = HipDevice(0);
...
TEST(FP16TestHIP, SubOperatorBroadcastVector2)
{
    // Broadcasting vector subtraction
    HipDevice hipDevice = HipDevice(0);
...
TEST(FP16TestHIP, ConcatOperatorBasic)
{
...
TEST(FP16TestHIP, ConcatOperatorShapeMismatchError)
{
...
TEST(FP16TestHIP, ConstantOperatorBasic)
{
...
// ----------------------- ConvOperator Tests -----------------------
TEST(FP16TestHIP, ConvOperatorBasic)
{
...
// ----------------------- DivOperator Tests -----------------------
TEST(FP16TestHIP, DivOperatorBasic)
{
    // Basic division test
    HipDevice hipDevice = HipDevice(0);
    Tensor t1(TensorDataType::FLOAT16, {2, 2}, std::vector<half_t>{10.0f, 20.0f, 30.0f, 40.0f}, &hipDevice);
...
TEST(FP16TestHIP, GatherOperatorBasic)
{
    // Basic gather test
    HipDevice hipDevice = HipDevice(0);
...
// TEST(FP16TestHIP, MatMulOperatorBasic)
// {
...
TEST(FP16TestHIP, MaxPoolOperatorBasic)
{
    // Basic MaxPool test
    HipDevice hipDevice = HipDevice(0);
    Tensor X(TensorDataType::FLOAT16, {1, 1, 4, 4},
...
// ----------------------- MulOperator Tests -----------------------
TEST(FP16TestHIP, MulOperatorBasic)
{
...
TEST(FP16TestHIP, SigmoidOperatorBasic)
{
    // Basic sigmoid test
    HipDevice hipDevice = HipDevice(0);
...
// ----------------------- SliceOperator Tests -----------------------
TEST(FP16TestHIP, SliceOperatorBasic)
{
    // Basic slice test
    HipDevice hipDevice = HipDevice(0);
    Tensor data(TensorDataType::FLOAT16, {3, 4},
...
TEST(FP16TestHIP, SoftmaxOperatorBasic)
{
    // Basic softmax test
    HipDevice hipDevice = HipDevice(0);
...
// ----------------------- SplitOperator Tests -----------------------
TEST(FP16TestHIP, SplitOperatorBasic)
{
    // Basic split test
    HipDevice hipDevice = HipDevice(0);
...
TEST(FP16TestHIP, TransposeOperatorBasic)
{
...
TEST(FP16TestHIP, ReshapeOperatorBasic)
{
    // Basic reshape test
    HipDevice hipDevice = HipDevice(0);
...
TEST(FP16TestHIP, ResizeOperatorBasic)
{
...
// ----------------------- ShapeOperator Tests -----------------------
TEST(FP16TestHIP, ShapeOperatorBasic)
{
