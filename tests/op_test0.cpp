...
TEST(OperatorTest0, AddOperatorBasic)
{
    ...
    const OperatorRegistry::OperatorFunctions* add_op = OperatorRegistry::getOperatorFunctions(OperatorType::Add);
    ...
    run_and_check_operator(add_op, {t1, t2}, outputs, {expected}, {}, OperatorExecuteResult::SUCCESS, DeviceType::CPU);
}
